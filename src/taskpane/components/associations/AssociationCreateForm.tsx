  ...
  return (
    <Stack spacing={2.2}>
      ...
      >
        ...
        >
          <MenuItem value="contacts" sx={{ fontSize: "13px" }}>
            Contact
          </MenuItem>
          <MenuItem value="companies" sx={{ fontSize: "13px" }}>
            Company
          </MenuItem>
          <MenuItem value="deals" sx={{ fontSize: "13px" }}>
            Deal
          </MenuItem>
          <MenuItem value="tasks" sx={{ fontSize: "13px" }}>
            Task
          </MenuItem>
        </TextField>
