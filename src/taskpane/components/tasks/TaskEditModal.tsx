...
>
  ...
  >
    <Stack spacing={2.2} sx={{ pt: 1.5 }}>
      ...
      >
        <MenuItem value="NOT_STARTED" sx={{ fontSize: "13px" }}>Not Started</MenuItem>
        <MenuItem value="IN_PROGRESS" sx={{ fontSize: "13px" }}>In Progress</MenuItem>
        <MenuItem value="COMPLETED" sx={{ fontSize: "13px" }}>Completed</MenuItem>
        <MenuItem value="WAITING" sx={{ fontSize: "13px" }}>Waiting</MenuItem>
        <MenuItem value="DEFERRED" sx={{ fontSize: "13px" }}>Deferred</MenuItem>
      </TextField>
      ...
      >
        <MenuItem value="TODO" sx={{ fontSize: "13px" }}>To-do</MenuItem>
        <MenuItem value="CALL" sx={{ fontSize: "13px" }}>Call</MenuItem>
        <MenuItem value="EMAIL" sx={{ fontSize: "13px" }}>Email</MenuItem>
        <MenuItem value="MEETING" sx={{ fontSize: "13px" }}>Meeting</MenuItem>
      </TextField>
